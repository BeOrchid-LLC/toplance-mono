      ...
      <Shell className="flex h-[var(--bar-h)] items-center gap-4">
        ...
        <div className="ms-auto flex items-center gap-2 sm:gap-3">
          ...
          <Dialog>
            ...
            <DialogContent
              className={cn(
                "left-0 top-[var(--bar-h)] max-h-[calc(100dvh-var(--bar-h))] max-w-none translate-x-0 translate-y-0 gap-0 rounded-none rounded-b-lg border-x-0 border-t-0 p-0 pb-2 pt-16",

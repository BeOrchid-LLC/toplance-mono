...
export const INVITE_PAGE: {
  ...
  platformHeading: {
    en: "BeOrchid has invited you to the platform workspace",
    ha: "BeOrchid ta gayyace ku zuwa wurin aikin dandamali",
    yo: "BeOrchid ti pè yín sí ibi-iṣẹ́ pátáforù náà",
    ig: "BeOrchid akpọọla gị òkù na ebe ọrụ ikpo okwu ahụ",
    fr: "BeOrchid vous a invité dans l'espace de travail de la plateforme",
    pt: "A BeOrchid convidou-o para o espaço de trabalho da plataforma",
    sw: "BeOrchid amekualika kwenye eneo la kazi la jukwaa",
    ar: "دعتك BeOrchid إلى مساحة عمل المنصة",
    tw: "BeOrchid afrɛ wo aba platform adwumayɛbea no so",
    zu: "I-BeOrchid ikumemele endaweni yokusebenzela yenkundla",
  },
  platformNotice: {
    en: "You will be asked to set up a second factor before the workspace opens. It is not optional — the workspace curates what every traveller on a route is told to bring.",
    ha: "Za a nemi ka kafa hanyar tabbatarwa ta biyu kafin wurin aikin ya buɗe. Ba zaɓi ba ne — wurin aikin yana tsara abin da ake gaya wa kowane matafiyi ya kawo.",
    yo: "A ó béèrè lọ́wọ́ yín láti ṣètò ọ̀nà ìjẹ́rìí kejì kí ibi-iṣẹ́ náà tó ṣí. Kì í ṣe àṣàyàn — ibi-iṣẹ́ náà ni ó ń pinnu ohun tí a sọ fún gbogbo arìnrìn-àjò láti mú wá.",
    ig: "A ga-arịọ gị ka ị tọọ ụzọ nkwenye nke abụọ tupu ebe ọrụ emeghe. Ọ bụghị nhọrọ — ebe ọrụ na-ahazi ihe a na-agwa onye njem ọ bụla ka o weta.",
    fr: "Il vous sera demandé de configurer un second facteur avant l'ouverture de l'espace de travail. Ce n'est pas facultatif : l'espace de travail détermine ce qu'on demande d'apporter à chaque voyageur.",
    pt: "Ser-lhe-á pedido que configure um segundo fator antes de o espaço de trabalho abrir. Não é opcional — o espaço de trabalho define o que se pede a cada viajante que leve.",
    sw: "Utaombwa kuweka kithibitishi cha pili kabla eneo la kazi halijafunguka. Si hiari — eneo la kazi huamua kile kila msafiri anaambiwa alete.",
    ar: "سيُطلب منك إعداد عامل تحقق ثانٍ قبل فتح مساحة العمل. وهذا ليس اختياريًا — فمساحة العمل تحدد ما يُطلب من كل مسافر إحضاره.",
    tw: "Wɔbɛka akyerɛ wo sɛ si nokwaredi a ɛtɔ so mmienu bi hɔ ansa na adwumayɛbea no abue. Ɛnyɛ nea wobetumi apo — adwumayɛbea no na ɛkyerɛ nea wɔka kyerɛ ɔkwantuni biara sɛ ɔmfa mmra.",
    zu: "Uzocelwa ukuba usethe indlela yesibili yokuqinisekisa ngaphambi kokuba indawo yokusebenzela ivuleke. Akukhethwa — indawo yokusebenzela inquma okutshelwa wonke umhambi ukuba akulethe.",
  },

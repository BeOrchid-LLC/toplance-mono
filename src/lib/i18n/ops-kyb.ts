...
export const OPS_KYB: {
  ...
  intro: {
    en: "Every agency's verification file. An agency's workspace opens only once all six requirements are verified here.",
    ha: "Fayil ɗin tabbatarwa na kowace hukuma. Wurin aikin hukuma yana buɗewa ne kawai bayan an tabbatar da duk buƙatu shida a nan.",
    yo: "Fáìlì ìjẹ́rìísí ilé-iṣẹ́ kọ̀ọ̀kan. Ibi-iṣẹ́ ilé-iṣẹ́ kan yóò ṣí nìkan lẹ́yìn tí a bá ti jẹ́rìísí gbogbo ìbéèrè mẹ́fà níbí.",
    ig: "Faịlụ nkwenye nke ụlọ ọrụ ọ bụla. Ebe ọrụ ụlọ ọrụ na-emeghe naanị mgbe a kwadoro ihe achọrọ isii niile ebe a.",
    fr: "Le dossier de vérification de chaque agence. L'espace de travail d'une agence ne s'ouvre qu'une fois les six exigences vérifiées ici.",
    pt: "O processo de verificação de cada agência. O espaço de trabalho de uma agência só abre depois de os seis requisitos serem verificados aqui.",
    sw: "Faili ya uthibitisho ya kila wakala. Eneo la kazi la wakala hufunguka tu baada ya mahitaji yote sita kuthibitishwa hapa.",
    ar: "ملف التحقق لكل وكالة. لا تُفتح مساحة عمل الوكالة إلا بعد التحقق من المتطلبات الستة جميعها هنا.",
    tw: "Adwumakuo biara ne nhwehwɛmu krataa. Adwumakuo bi adwumayɛbea bue bere a wɔasɔ ahwehwɛdeɛ nsia no nyinaa ano wɔ ha.",
    zu: "Ifayela lokuqinisekisa lawo wonke ama-ejensi. Indawo yokusebenzela ye-ejensi ivuleka kuphela lapho zonke izidingo eziyisithupha seziqinisekisiwe lapha.",
  },
  queuePanel: {

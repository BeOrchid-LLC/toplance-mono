...
export const AGENCY: {
  ...
  pageTitle: {
    en: "Organisation workspace",
    ha: "Wurin aikin kamfani",
    yo: "Ibi-iṣẹ́ àjọ",
    ig: "Ebe ọrụ ụlọ ọrụ",
    fr: "Espace de travail de l'organisation",
    pt: "Espaço de trabalho da organização",
    sw: "Eneo la kazi la shirika",
    ar: "مساحة عمل المؤسسة",
    tw: "Akuo adwumayɛbea",
    zu: "Indawo yokusebenzela yenhlangano",
  },
  navDashboard: {
    en: "Dashboard",
    ha: "Bayyani",
  ...
  logoPanelBody: {
    en: "Shown along the top of the side panel on every screen of this workspace. Your agency's name is used until you add one.",
    ha: "Ana nuna shi a saman gefen kowane shafi na wannan wurin aiki. Ana amfani da sunan hukumarka har sai ka ƙara ɗaya.",
    yo: "Ó máa hàn ní òkè pánẹ́ẹ̀lì ẹ̀gbẹ́ ní gbogbo ojú-ìwé ibi-iṣẹ́ yìí. Orúkọ ilé-iṣẹ́ rẹ ni a ó lò títí ìwọ ó fi fi ọ̀kan kún un.",
    ig: "A na-egosi ya n'elu mpanaka akụkụ na ihuenyo ọ bụla nke ebe ọrụ a. A na-eji aha ụlọ ọrụ gị ruo mgbe ị tinyere otu.",
    fr: "Affiché en haut du panneau latéral sur chaque écran de cet espace de travail. Le nom de votre agence est utilisé tant que vous n'en ajoutez pas.",
    pt: "Mostrado no topo do painel lateral em todos os ecrãs deste espaço de trabalho. O nome da sua agência é usado até adicionar um.",
    sw: "Huonyeshwa juu ya paneli ya kando katika kila skrini ya eneo hili la kazi. Jina la wakala wako hutumika hadi utakapoongeza moja.",
    ar: "يظهر أعلى اللوحة الجانبية في كل شاشة من شاشات مساحة العمل هذه. يُستخدم اسم وكالتك إلى أن تضيف شعارًا.",
    tw: "Ɛda adi wɔ nkyɛn panel no atifi wɔ adwumayɛbea yi kratafa biara so. Wɔde w'adwumakuo din di dwuma kɔsi sɛ wode bi bɛka ho.",
    zu: "Ikhonjiswa phezulu kwephaneli eseceleni kuso sonke isikrini salendawo yokusebenzela. Igama le-ejensi yakho lisetshenziswa uze ungeze elilodwa.",
  },
  roleLabel: {

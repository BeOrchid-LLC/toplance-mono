...
export const ERROR_PAGE: {
  ...
  backToConsole: {
    en: "Back to the workspace",
    ha: "Koma ga wurin aiki",
    yo: "Padà sí ibi-iṣẹ́",
    ig: "Laghachi na ebe ọrụ",
    fr: "Retour à l'espace de travail",
    pt: "Voltar ao espaço de trabalho",
    sw: "Rudi kwenye eneo la kazi",
    ar: "العودة إلى مساحة العمل",
    tw: "San kɔ adwumayɛbea",
    zu: "Buyela endaweni yokusebenzela",
  },
  backToStart: {

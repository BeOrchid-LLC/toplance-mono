...
ALTER TABLE "invitations" ADD CONSTRAINT "platform_invite_has_no_org" CHECK (("invitations"."kind" = 'platform_staff' and "invitations"."org_id" is null and "invitations"."staff_rank" is not null)
       or ("invitations"."kind" <> 'platform_staff' and "invitations"."org_id" is not null and "invitations"."staff_rank" is null));
...
export const AGENCY_DOOR_PANEL: {
  ...
  body: {
    en: "The organisation workspace shows completion, status and destination for everyone whose seat you sponsor. Passports, bank statements and police certificates stay between the traveler and Toplance.",
    ha: "Wurin aikin ƙungiya yana nuna cikawa, matsayi da wurin zuwa na kowa da kuke ɗaukar nauyin wurinsa. Fasfo, bayanan banki da takardar shaidar ɗan sanda suna tsakanin matafiyi da Toplance kaɗai.",
    yo: "Ibi-iṣẹ́ àjọ ń fi ìparí, ipò àti ibi tí wọ́n ń lọ hàn fún gbogbo ẹni tí o ṣàrànṣe àyè rẹ̀. Ìwé ìrìnnà, àkọsílẹ̀ báǹkì àti ìwé ẹ̀rí ọlọ́pàá wà láàrin arìnrìn-àjò àti Toplance nìkan.",
    ig: "Ebe ọrụ ụlọ ọrụ na-egosi mmecha, ọnọdụ na ebe ọ na-aga maka onye ọ bụla ị kwadoro oche ya. Paspọtụ, akwụkwọ ndekọ ụlọ akụ na asambodo ndị uwe ojii na-anọ naanị n'etiti onye njem na Toplance.",
    fr: "L'espace de travail de l'organisation affiche l'avancement, le statut et la destination de chaque personne dont vous parrainez le siège. Passeports, relevés bancaires et certificats de police restent entre le voyageur et Toplance.",
    pt: "O espaço de trabalho da organização mostra a conclusão, o estado e o destino de todas as pessoas cujo lugar patrocina. Passaportes, extratos bancários e certificados de registo criminal ficam apenas entre o viajante e a Toplance.",
    sw: "Eneo la kazi la shirika linaonyesha ukamilifu, hali na mahali anapokwenda kila mtu unayemdhamini kiti. Pasipoti, taarifa za benki na vyeti vya polisi hubaki kati ya msafiri na Toplance pekee.",
    ar: "توضح مساحة عمل المؤسسة نسبة الإنجاز والحالة والوجهة لكل شخص تموّل مقعده. تبقى جوازات السفر وكشوف الحسابات البنكية وشهادات حسن السير والسلوك بين المسافر و Toplance فقط.",
    tw: "Kuo no adwumayɛbea kyerɛ dwumadie a wɔawie, tebea ne baabi a obiara a wugye no kongua ho boa no rekɔ. Pasport, sikakorabea nsɛm ne polisifoɔ krataa gyina ɔkwantuni ne Toplance ntam nkutoo.",
    zu: "Indawo yokusebenzela yenhlangano ibonisa ukuphothulwa, isimo nendawo yalowo naye owonke oxhasa isihlalo sakhe. Amaphasipoti, izitatimende zasebhange nezitifiketi zamaphoyisa kuhlala phakathi komhambi ne-Toplance kuphela.",
  },
  bullets: [
    {

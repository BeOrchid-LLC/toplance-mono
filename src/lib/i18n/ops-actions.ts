...
export const OPS_ACTIONS: {
   ...
   */
  chooseARole: {
    en: "Choose whether this person is a director or a reviewer.",
    ha: "Zaɓi ko wannan mutumin darakta ne ko mai dubawa.",
    yo: "Yàn bóyá ẹni yìí jẹ́ olùdarí tàbí olùyẹ̀wò.",
    ig: "Họrọ ma onye a ọ̀ bụ onye nduzi ma ọ bụ onye nyocha.",
    fr: "Choisissez si cette personne est directeur ou réviseur.",
    pt: "Escolha se esta pessoa é diretora ou revisora.",
    sw: "Chagua kama mtu huyu ni mkurugenzi au mkaguzi.",
    ar: "اختر ما إذا كان هذا الشخص مديرًا أو مراجعًا.",
    tw: "Paw sɛ saa onipa yi yɛ ɔpanyin anaa ɔhwɛfoɔ.",
    zu: "Khetha ukuthi lo muntu ungumqondisi noma umbuyekezi.",
  },
  ...
  ownerEmailInvalid: {
    en: "Enter a valid email address for the first director.",
    ha: "Shigar da adireshin imel mai inganci don daraktan farko.",
    yo: "Tẹ àdírẹ́sì ímeèlì tó tọ́ sí i fún olùdarí àkọ́kọ́.",
    ig: "Tinye adreesị ozi-e ziri ezi maka onye nduzi mbụ.",
    fr: "Saisissez une adresse e-mail valide pour le premier directeur.",
    pt: "Introduza um endereço de email válido para o primeiro diretor.",
    sw: "Weka anwani sahihi ya barua pepe kwa mkurugenzi wa kwanza.",
    ar: "أدخل عنوان بريد إلكتروني صالحًا للمدير الأول.",
    tw: "Kyerɛw email address a ɛfata ma ɔpanyin a odi kan no.",
    zu: "Faka ikheli le-imeyili elisebenzayo lomqondisi wokuqala.",
  },
  seatsInvalid: {
   ...
   */
  lastOwner: {
    en: "This agency has only one director. Promote someone else before you remove this one.",
    ha: "Wannan hukumar tana da darakta ɗaya kacal. Ɗaga wani kafin ka cire wannan.",
    yo: "Ilé-iṣẹ́ yìí ní olùdarí kan ṣoṣo. Gbé ẹlòmíràn ga kí o tó yọ ẹni yìí kúrò.",
    ig: "Ụlọ ọrụ a nwere naanị otu onye nduzi. Bulie onye ọzọ tupu ị wepụ onye a.",
    fr: "Cette agence n'a qu'un seul directeur. Promouvez quelqu'un d'autre avant de retirer celui-ci.",
    pt: "Esta agência tem apenas um diretor. Promova outra pessoa antes de remover este.",
    sw: "Wakala huyu ana mkurugenzi mmoja tu. Mpandishe mtu mwingine kabla ya kumwondoa huyu.",

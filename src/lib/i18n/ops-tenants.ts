...
export const OPS_TENANTS: {
  ...
  fieldOwnerEmail: {
    en: "First owner's email",
    ha: "Imel na mai gidan farko",
    yo: "Ímeèlì onílé àkọ́kọ́",
    ig: "Email onye nwe ya mbụ",
    fr: "E-mail du premier propriétaire",
    pt: "Email do primeiro proprietário",
    sw: "Barua pepe ya mmiliki wa kwanza",
    ar: "البريد الإلكتروني للمالك الأول",
    tw: "Owura a odi kan no email",
    zu: "I-imeyili yomnikazi wokuqala",
  },
  fieldOwnerName: {
    en: "First owner's name (optional)",
    ha: "Sunan mai gidan farko (ba dole ba)",
    yo: "Orúkọ onílé àkọ́kọ́ (tí kò ṣe dandan)",
    ig: "Aha onye nwe ya mbụ (ọ bụghị iwu)",
    fr: "Nom du premier propriétaire (facultatif)",
    pt: "Nome do primeiro proprietário (opcional)",
    sw: "Jina la mmiliki wa kwanza (si lazima)",
    ar: "اسم المالك الأول (اختياري)",
    tw: "Owura a odi kan no din (ɛnhia)",
    zu: "Igama lomnikazi wokuqala (akuphoqelekile)",
  },
  createButton: {
  ...
  promoteButton: {
    en: "Make owner",
    ha: "Mai da shi mai gida",
    yo: "Sọ ọ́ di onílé",
    ig: "Mee ka ọ bụrụ onye nwe ya",
    fr: "Nommer propriétaire",
    pt: "Tornar proprietário",
    sw: "Mfanye mmiliki",
    ar: "تعيينه مالكًا",
    tw: "Ma no nyɛ ɔwura",
    zu: "Yenza umnikazi",
